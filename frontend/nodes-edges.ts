...
export const populateNodesAndEdges = (records: Record[], settings: Settings): {nodes: Array<any>, edges: Array<any>} => {
...
export const addConnectionToTable = async (nodes: Node[], params: Connection | Edge, obj: { table: Table, field: Field}) => {
...
export const deleteConnectionsFromTable = async (
    ...
    const filteredFieldData = linkFieldData?.filter(d => d.name !== edge.target) || [];
